            ...
            <section className='w-full h-auto md:h-314.5 flex flex-col  items-center'>
                <motion.div  className="bg-bg-color  h-auto md:h-149.75 w-full flex flex-col justify-center items-center lg:gap-32 md:gap-24  md:flex-col  md:justify-center pt-24">
                    <div className='flex flex-col-reverse h-auto md:flex-col-reverse lg:flex-row  font-custom-font lg:w-[95%] lg:h-80 w-full justify-center items-center font-semibold lg:gap-38 gap-24 md:h-162.5'>
                        <motion.div initial={{opacity:0 , y:100}} whileInView={{ opacity: 1, y: 0 }}
                          ...
                          viewport={{ once: true, amount: 0.3 }} transition={{duration:1 , ease:'easeOut' ,delay:0.8}} className='text-p-color md:absolute -bottom-12 lg:bottom-0 lg:relative   md:text-[14px]'>Where to grow your business as a photographer: site or social media?</motion.p>
                ...
                <div className='flex flex-col justify-center items-center w-full h-auto lg:h-47.5 mt-4 lg:mt-64 gap-4'>
                    ...
                    <Reveal animation='left'>
                        <motion.div initial={{ opacity: 0, y: 100 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.3 }} transition={{ duration: 1, ease: "easeOut", delay: 0.3 }} className='lg:h-104 h-auto w-full lg:w-360 gap-24 md:gap-4 flex flex-col  justify-center items-center mt-11  '>
                            ...
                            <motion.div initial={{ opacity: 0, x: -100 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true, amount: 0.3 }} transition={{ duration: 1, ease: "easeOut", delay: 0.8 }} className='flex flex-col justify-center items-center md:flex-col gap-4 md:gap-8  lg:w-[75%] xl:w-full  lg:flex-row lg:gap-1   lg:h-70  lg:justify-evenly'>
                                <motion.div initial={{opacity:0 , x:-100}}    transition={{ duration: 1, ease: "easeOut", delay: 0.5 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true, amount: 1 }} className='w-74.75 h-65 rounded-lg gap-2 flex flex-col md:w-112.5 md:h-87.5 lg:w-74.75 lg:h-65 justify-center items-center text-center  shadow-[0_2px_4px_0_#ABBED133]'>
