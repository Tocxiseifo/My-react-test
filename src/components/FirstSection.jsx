            ...
            <section className='w-full md:w-full h-314.5 flex flex-col  items-center'>
                ...
                <div className='flex flex-col justify-center items-center w-full h-47.5 mt-64 gap-4'>
                    ...
                    <Reveal animation='left'>
                        <motion.div initial={{ opacity: 0, y: 100 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.3 }} transition={{ duration: 1, ease: "easeOut", delay: 0.2 }} className='h-104 w-360 gap-4 flex flex-col justify-center items-center mt-11'>
                            ...
                            <motion.div initial={{ opacity: 0, x: -100 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true, amount: 0.3 }} transition={{ duration: 1, ease: "easeOut", delay: 0.4 }} className='flex flex-col justify-center items-center md:flex-row md:w-360 md:h-70 md:justify-evenly'>
                                ...
                                <motion.div initial={{ opacity: 0, x: -100 }} whileInView={{ opacity: 1, x: 0 }}  viewport={{ once: true, amount: 0.3 }} transition={{ duration: 1, ease: "easeOut", delay: 0.7 }} className='w-74.75 h-65 rounded-lg gap-2 flex flex-col justify-center items-center text-center shadow-[0_2px_4px_0_#ABBED133]'>
                                ...
                                <motion.div initial={{ opacity: 0, x: -100 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true, amount: 0.3 }} transition={{ duration: 1, ease: "easeOut", delay: 1 }} className='w-74.75 h-65 rounded-lg gap-2 flex flex-col justify-center items-center text-center shadow-[0_2px_4px_0_#ABBED133]'>
