            ...
            <section className="xl:h-[2242.4px] w-full flex h-auto flex-col gap-12">
                <motion.div ref={ref} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.3 }}  initial={{opacity:0 , y:-100}}  transition={{duration:1 , ease:'easeOut' ,delay:0.2}} className="w-full h-auto lg:h-108.25 flex flex-col lg:flex-row md:w-[75%] lg:w-full relative  md:top-212.5 lg:top-0  justify-center items-center  lg:justify-center  lg:items-center ">
                    ...
                    viewport={{ once: true, amount: 0.3 }} transition={{duration:1 , ease:'easeOut' ,delay:0.8}}  className='flex flex-col justify-center lg:items-start text-center md:flex-col w-full h-auto lg:h-67 lg:w-165.25 gap-4 items-center'>
                        <h1 className='lg:h-22 w-full  text-center h-auto ml-1 md:ml-38 lg:ml-0  lg:w-137.5  text-2xl lg:text-4xl leading-11 lg:text-left text-text-color font-semibold'>The unseen of spending three years at Pixelgrade</h1>
                        <p className='lg:h-20 lg:w-137.5 xl:w-150.25 h-auto w-full text-p-color text-sm leading-5 font-normal text-center md:ml-36 lg:ml-0  lg:text-start'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed sit amet justo ipsum. Sed accumsan quam vitae est varius fringilla. Pellentesque placerat vestibulum lorem sed porta. Nullam mattis tristique iaculis. Nullam pulvinar sit amet risus pretium auctor. Etiam quis massa pulvinar, aliquam quam vitae, tempus sem. Donec elementum pulvinar odio.</p>
                ...
                <motion.div ref={ref} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.3 }} initial={{opacity:0 , y:100}}  transition={{duration:1 , ease:'easeOut' ,delay:0.4}} className='w-full  h-auto lg:h-72 flex flex-col justify-center items-center md:flex lg:flex-row lg:justify-evenly lg:items-center md:mt-212.5 lg:mt-0 lg:text-center bg-bg-color'>
                    <motion.div initial={{opacity:0 , y:-100}} whileInView={{ opacity: 1, y: 0 }}
                        ...
                        viewport={{ once: true, amount: 0.3 }} transition={{duration:1 , ease:'easeOut' ,delay:1.2}} className='text-main-green text-center text-2xl lg:text-4xl leading-11 font-semibold '>business reinvent itself</motion.span></motion.h1>
                        <motion.p initial={{opacity:0 , y:-100}} whileInView={{ opacity: 1, y: 0 }}
                        viewport={{ once: true, amount: 0.3 }} transition={{duration:1 , ease:'easeOut' ,delay:1.3}} className='text-[#18191F] text-[14px] lg:text-[16px] lg:ml-4 xl:ml-0 leading-6 font-normal'>We reached here with our hard work and dedication</motion.p>
                    </motion.div>
                    <motion.div initial={{opacity:0 , y:100}} whileInView={{ opacity: 1, y: 0 }}
                        viewport={{ once: true, amount: 0.3 }} transition={{duration:1 , ease:'easeOut' ,delay:0.4}} className='lg:w-135 md:mb-5  w-full h-auto lg:h-40 flex flex-col items-center justify-center gap-10 mt-8 mb-5 lg:mb-0 lg:mt-0 md:ml-19 lg:ml-0 '>
                        <motion.div initial={{opacity:0 , y:-100}} whileInView={{ opacity: 1, y: 0 }}
                            viewport={{ once: true, amount: 0.3 }} transition={{duration:1 , ease:'easeOut' ,delay:1}} className='flex md:flex-row justify-center items-center flex-col  w-full h-auto  md:w-135 md:h-15 gap-7.5'>
                        ...
                        <motion.div initial={{opacity:0 , y:-100}} whileInView={{ opacity: 1, y: 0 }}
                            viewport={{ once: true, amount: 0.3 }} transition={{duration:1 , ease:'easeOut' ,delay:1.5}} className='flex md:flex-row justify-center items-center flex-col  w-full h-auto  md:w-135 md:h-15 gap-7.5'>
                            <div className='w-63.75 h-15 flex flex-row gap-4 items-center'>
                ...
                <motion.div ref={ref} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.3 }}  initial={{opacity:0 , y:-100}}  transition={{duration:1 , ease:'easeOut' ,delay:0.2}} className="w-full h-auto lg:h-108.25 flex flex-col md:flex-row md:justify-center  md:items-center justify-center text-center items-center ">
                    ...
                    <motion.div initial={{opacity:0 , y:100}} whileInView={{ opacity: 1, y: 0 }}
                        viewport={{ once: true, amount: 0.3 }} transition={{duration:1 , ease:'easeOut' ,delay:0.8}}  className='flex flex-col justify-center gap-8 items-center  lg:items-start text-center md:flex-col lg:h-77 h-auto w-full lg:w-150.25 md:mr-3 lg:mr-0  '>
                        <div className='lg:w-152.25 h-auto w-full text-center  lg:h-56 gap-3 flex flex-col'>
                            <h1 className='lg:h-22 lg:w-137.5 text-2xl lg:text-4xl leading-11 text-center lg:text-left text-text-color font-semibold'>How to design your site footer like we did</h1>
                            <p className='lg:h-20 lg:w-137.5 text-p-color text-sm leading-5 font-normal text-center lg:text-start xl:w-150.25'>Donec a eros justo. Fusce egestas tristique ultrices. Nam tempor, augue nec tincidunt molestie, massa nunc varius arcu, at scelerisque elit erat a magna. Donec quis erat at libero ultrices mollis. In hac habitasse platea dictumst. Vivamus vehicula leo dui, at porta nisi facilisis finibus. In euismod augue vitae nisi ultricies, non aliquet urna tincidunt. Integer in nisi eget nulla commodo faucibus efficitur quis massa. Praesent felis est, finibus et nisi ac, hendrerit venenatis libero. Donec consectetur faucibus ipsum id gravida.</p>
                        </div>
                    ...
                    <motion.div ref={ref}  initial={{ opacity: 0, y: 100 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.1 }} transition={{ duration: 1, ease: 'easeOut', delay: 0.2 }} className='w-full lg:h-97.5 h-auto flex flex-col justify-center items-center md:text-center md:h-190 lg:flex-row lg:justify-center lg:items-center lg:text-center lg:gap-19.5 bg-bg-color' >
                        ...
                        <motion.dev className='lg:w-187 w-full h-auto lg:h-81   lg:gap-8'initial={{ opacity: 0, x: 100 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true, amount: 0.1 }} transition={{ duration: 1, ease: 'easeOut', delay: 0.8 }}>
                            <motion.dev  className='lg:h-81 lg:w-187 w-full h-auto gap-4 flex flex-col justify-center lg:text-start text-center '>
                                ...
                                <div className='xl:w-187 lg:w-170  w-full h-auto lg:h-12 text-center gap-8 flex flex-col lg:flex-row items-center'>
                                    <div className='lg:w-123.25  lg:h-12 gap-10.25 w-[75%] flex-wrap md:flex-nowrap md:w-full md:justify-center lg:flex-nowrap md:gap-18 lg:gap-10.25 h-auto flex flex-row'>
                                        <motion.img src={img20} initial={{opacity:0 , y:100}} whileInView={{ opacity: 1, y: 0 }}
                                        viewport={{ once: true, amount: 0.3 }}  transition={{duration:1 , ease:'easeOut' , delay:'0.3'}} className='w-12 lg:w-10 xl:w-12 xl:h-12 lg:h-10 h-12 rounded-lg'/> 
                                        <motion.img src={img21} initial={{opacity:0 , y:100}} whileInView={{ opacity: 1, y: 0 }}
                                        viewport={{ once: true, amount: 0.3 }}  transition={{duration:1 , ease:'easeOut' , delay:'0.5'}} className='w-12 lg:w-10 xl:w-12 xl:h-12 lg:h-10 h-12 rounded-lg'/>
                                        <motion.img src={img22} initial={{opacity:0 , y:100}} whileInView={{ opacity: 1, y: 0 }}
                                        viewport={{ once: true, amount: 0.3 }}  transition={{duration:1 , ease:'easeOut' , delay:'0.7'}} className='w-12 lg:w-10 xl:w-12 xl:h-12 lg:h-10 h-12 rounded-lg'/>
                                        <motion.img src={img23} initial={{opacity:0 , y:100}} whileInView={{ opacity: 1, y: 0 }}
                                        viewport={{ once: true, amount: 0.3 }}  transition={{duration:1 , ease:'easeOut' , delay:'0.9'}} className='w-12 lg:w-10 xl:w-12 xl:h-12 lg:h-10 h-12 rounded-lg'/>
                                        <motion.img src={img24} initial={{opacity:0 , y:100}} whileInView={{ opacity: 1, y: 0 }}
                                        viewport={{ once: true, amount: 0.3 }}  transition={{duration:1 , ease:'easeOut' , delay:'1'}} className='w-12 lg:w-10 xl:w-12 xl:h-12 lg:h-10 h-12 rounded-lg'/>
                                        <motion.img src={img25} initial={{opacity:0 , y:100}} whileInView={{ opacity: 1, y: 0 }}
                                        viewport={{ once: true, amount: 0.3 }}  transition={{duration:1 , ease:'easeOut' , delay:'1.2'}} className='w-12 lg:w-10 xl:w-12 xl:h-12 lg:h-10 h-12 rounded-lg'/>
                                    </div>
                        ...
                        <div>
                            ...
                            <motion.div initial={{opacity:0 , x:-100}} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true, amount: 0.1 }} transition={{duration:1 , ease:'easeOut' , delay:'0.7'}} className='lg:h-91.5 h-auto w-full flex flex-col justify-center items-center gap-12 md:justify-center   md:gap-4 lg:flex-row lg:justify-center md:items-center lg:-mt-10'>
                                <motion.div initial={{opacity:0 , x:-100}} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true, amount: 0.1 }} transition={{duration:1 , ease:'easeOut' , delay:'0.5'}} className='w-92 h-91.5 lg:left-4 xl:left-0  relative flex flex-col justify-center  items-center'>
                                    ...
                                    <div className='lg:w-79.25 lg:h-44 md:w-[95%] md:h-auto rounded-lg gap-4 flex flex-col text-center justify-center items-center bg-bg-color -m-24 z-10 hover:duration-500 duration-500 transition-all hover:scale-110 shadow-[0px_8px_16px_0_#ABBED166]'>
                                        <h1 className='text-p-color text-[20px] mt-2.5 md:mt-4 lg:mt-0  leading-7 w-71.25 h-21 font-semibold'>Creating Streamlined Safeguarding Processes with OneRen</h1>
                                ...
                                <motion.div initial={{opacity:0 , x:-100}} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true, amount: 0.1 }} transition={{duration:1 , ease:'easeOut' , delay:'0.8'}} className='w-92 h-91.5 lg:left-4 xl:left-0  relative flex flex-col justify-center items-center '>
                                    ...
                                    <div className='lg:w-79.25 lg:h-44 rounded-lg gap-4 md:w-[95%] md:h-auto flex flex-col text-center justify-center items-center bg-bg-color -m-24 z-10 hover:duration-500 duration-500 transition-all hover:scale-110 shadow-[0px_8px_16px_0_#ABBED166]'>
                                        <h1 className='text-p-color text-[20px] mt-2.5 md:mt-4 lg:mt-0 leading-7 w-71.25 h-21 font-semibold'>What are your safeguarding responsibilities and how can you manage them?</h1>
                                        <span className='text-main-green w-71.25 gap-2 h-11 font-semibold text-[20px] leading-7 flex flex-row justify-center items-center cursor-pointer  hover:text-green-800 active:text-green-800 hover:duration-500 duration-500 transition-all'>Readmore <img src={img26} alt="" className='w-6 h-6' /></span>
                                    </div>
                                </motion.div>
                                <motion.div initial={{opacity:0 , x:-100}} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true, amount: 0.1 }} transition={{duration:1 , ease:'easeOut' , delay:'1.2'}} className='w-92 h-91.5  relative flex flex-col justify-center items-center'>
                                    ...
                                    <div className='lg:w-79.25 lg:h-44  rounded-lg gap-4 md:w-[95%] md:h-auto flex flex-col text-center justify-center items-center bg-bg-color -m-24 z-10 hover:duration-500 duration-500 transition-all hover:scale-110 shadow-[0px_8px_16px_0_#ABBED166]'>
                                        <h1 className='text-p-color text-[20px] mt-2.5 md:mt-4 lg:mt-0  leading-7 w-71.25 h-21 font-semibold'>Revamping the Membership Model with Triathlon Australia</h1>
                                        <span className='text-main-green w-71.25 gap-2 h-11 font-semibold text-[20px] leading-7 flex flex-row justify-center items-center cursor-pointer  hover:text-green-800 active:text-green-800 hover:duration-500 duration-500 transition-all'>Readmore <img src={img26} alt="" className='w-6 h-6' /></span>
                                    </div>
                                </motion.div>
                            </motion.div>
